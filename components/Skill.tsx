...
function Skill({ directionLeft, image }: Props) {
  return (
    ...
    <div className='group relative flex cursor-pointer'>
        ...
        >
          <Image className='object-cover w-24 h-24 md:w-28 md:h-28 xl:w-32 xl:h-32 filter group-hover:blur-sm transition duration-300 ease-in-out' src={image} alt="Prof Picture" />
        </motion.div>
